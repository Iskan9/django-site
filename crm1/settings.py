...
SECRET_KEY = 'n&r#*&7(=d1w-apednkpv8xin#q9^dzo=j-0xedp!4g)84uzcl'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['iskandjsite.herokuapp.com', '127.0.0.1']
...
# LANGUAGE_CODE = 'en-us' # был по умолчанию в административной панели англ язык

LANGUAGE_CODE = 'ru'  # меняем на русский
